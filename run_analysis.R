# in order to make sure everything works, I first load the package dplyr
library(dplyr)
# The files have been downloaded and unzipped into a dedicated directory which I had setup as working directory 
...
tidydataset <- mean_std_descriptive %>% group_by(subject_id,activity_type) %>% summarize_each (funs=mean )
# I then need to create the file 
